						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="clip-radio radio-primary">
									...
									<label for="rg-female" style = "color:lightblue;">
										Female
									</label>
									<input type="radio" id="rg-male" name="gender" value="male">
									<label for="rg-male" style = "color:lightblue;">
										Male
									</label>
								</div>
							</div>
							...
							<div class="form-group">
								<span class="input-icon">
									...
									<i class="fa fa-lock" style = "color:lightblue;"></i> </span>
							</div>
							<div class="form-group">
								<span class="input-icon">
							...
							<div class="form-group">
								<div class="checkbox clip-check check-primary">
									...
									<label for="agree" style = "color:lightblue;">
										I agree
									</label>
								</div>
							</div>
